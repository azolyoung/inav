...
PG_REGISTER_WITH_RESET_TEMPLATE(rcdeviceConfig_t, rcdeviceConfig, PG_RCDEVICE_CONFIG, 0);

PG_RESET_TEMPLATE(rcdeviceConfig_t, rcdeviceConfig,
    .initDeviceAttempts = 6,
    .initDeviceAttemptInterval = 1000,
);
